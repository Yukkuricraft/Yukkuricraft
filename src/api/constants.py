...
if CONFIGURATION_TYPE is None:
    raise RuntimeError("CONFIGURATION_TYPE was not set! Must be local, dev, prod. Aborting.")
...
if IS_LOCAL:
    G_CLIENT_ID = "1084736521175-4p43u0ddhru6qs6aqd6n4r2smmnffqcu.apps.googleusercontent.com"
    CORS_ORIGIN = "*"
    MIN_VALID_PROXY_PORT = 26600
    MAX_VALID_PROXY_PORT = 26700
    API_HOST = "api.localhost"
elif IS_DEV:
    G_CLIENT_ID = "1084736521175-2b5rrrpcs422qdc5458dhisdsj8auo0p.apps.googleusercontent.com"
